module github.com/toferc/rq_web
...
require (
	...
	github.com/thewhitetulip/Tasks v0.0.0-20191030021720-18142e220888
	github.com/toferc/runequest v0.0.0-20191019172956-f40eb01c1820
